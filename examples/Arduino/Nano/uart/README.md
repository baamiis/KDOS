...
| USB cable (Mini-USB for original Nano) | 1       |
...
cd KTOS/examples/Arduino/Nano/uart
```
...
|--------------------------------------|---------------------------------------------------|-----------------------------------------------------------|
| No banner after upload               | Serial monitor not yet open                       | Open the monitor and reset the Nano                       |
