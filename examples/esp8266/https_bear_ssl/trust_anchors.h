/* Auto-generated by make_trust_anchors.py — do not edit manually.
 * Regenerate: python3 make_trust_anchors.py <ca.pem> > trust_anchors.h */
...
#define TAs_NUM  ((int)(sizeof TAs / sizeof TAs[0]))
